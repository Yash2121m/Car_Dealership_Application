...
class _ChatScreenState extends State<ChatScreen> {
  ...
  int _scoreCar(Car c, _Prefs p) {
    ...
    final mileageVal = _getNumField(c, 'mileage');
    ...
    final powerVal = _getNumField(c, 'power');
    ...
    if (rating != null) s += (rating * 2).toInt();
